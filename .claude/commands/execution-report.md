...
Run this command immediately after completing an implementation, before the context is lost.

The execution report is used by `/system-review` for meta-level process analysis.
