 ...
 */
export function handleBuiltinCommand(
  command: string,
  args: string,
 ...
 */
function handleThinkCommand(args: string, currentState: boolean): BuiltinCommandResult {
 ...
 */
function handleSessionsCommand(sessionService?: SessionService): BuiltinCommandResult {
  if (!sessionService) {
    return {
 ...
 */
function handleRenameCommand(args: string, sessionId?: string): BuiltinCommandResult {
  if (!sessionId) {
    return {
 ...
 */
function handleStatusCommand(context: CommandContext): BuiltinCommandResult {
  const lines: string[] = [
    'PIV Loop CLI Status',
    '==================',
    '',
 ...
 */
function handlePermissionsCommand(args: string, context: CommandContext): BuiltinCommandResult {
 ...
 */
function handleDoctorCommand(context: CommandContext): BuiltinCommandResult {
  const checks: string[] = ['PIV Loop Health Check', '====================', ''];
 ...
 */
function handleStatsCommand(context: CommandContext): BuiltinCommandResult {
  const lines: string[] = [
    'Usage Statistics',
    '================',
    '',
 ...
 */
function handlePluginCommand(args: string, plugins: LoadedPlugin[]): BuiltinCommandResult {
