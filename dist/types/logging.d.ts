...
export type PIVDomain = 'orchestrator' | 'planner' | 'discovery' | 'implementer' | 'validator' | 'reviewer' | 'application';
/**
 * Standard state suffixes for lifecycle events.
 * Use these consistently across all event names.
 */
export type EventState = 'started' | 'progress' | 'completed' | 'failed' | 'validated' | 'rejected' | 'retrying' | 'cancelled' | 'timeout' | 'received' | 'sent';
/**
